...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/style_entrenar.css?v=<?php echo time(); ?>">
</head>
<body>
		<header class="titulo">
    <a href="menu_invoca.php">
        <img src="img/logo2.jfif" alt="logo" width="100px" height="100">
    </a>
        <div>
            <h1>Gym Register</h1>
	...
	<?php
		include_once("entrenar_panel.php");
